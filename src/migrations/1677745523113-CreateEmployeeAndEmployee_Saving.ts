...
export class CreateEmployeeAndEmployeeSaving1677745523113 implements MigrationInterface {
    name = 'CreateEmployeeAndEmployeeSaving1677745523113'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."employee_saving_type_enum" AS ENUM('SIMPANAN', 'AMBILAN')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."employee_saving_type_enum"`);
