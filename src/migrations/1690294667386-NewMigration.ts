...
export class NewMigration1690294667386 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "purchases" ADD CONSTRAINT "FK_9b0b022b73b29ea4ea3829862ad" FOREIGN KEY ("expenseId") REFERENCES "expenses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "purchases" DROP CONSTRAINT "FK_9b0b022b73b29ea4ea3829862ad"`);
