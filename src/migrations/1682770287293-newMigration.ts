...
export class newMigration1682770287293 implements MigrationInterface {
    name = 'newMigration1682770287293'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customers" ADD "phone_number" character varying`);
        await queryRunner.query(`ALTER TABLE "customers" ALTER COLUMN "address" DROP NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customers" ALTER COLUMN "address" SET NOT NULL`);
