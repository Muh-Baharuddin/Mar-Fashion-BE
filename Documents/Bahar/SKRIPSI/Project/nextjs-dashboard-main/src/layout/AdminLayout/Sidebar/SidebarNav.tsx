...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavItem icon={faShirt} href="/">Daftar Barang</SidebarNavItem>
      <SidebarNavGroup toggleIcon={faMoneyBill} toggleText="Keuanga">
        <SidebarNavItem href="/">Daftar Keuangan</SidebarNavItem>
        <SidebarNavItem href="/">Nota Pembelian</SidebarNavItem>
        <SidebarNavItem href="/">Nota Penjualan</SidebarNavItem>
      </SidebarNavGroup>
      <SidebarNavItem icon={faPencil} href="typography.html">Daftar Karyawan</SidebarNavItem>
      <SidebarNavItem icon={faChartPie} href="charts.html">Daftar Supplier</SidebarNavItem>
